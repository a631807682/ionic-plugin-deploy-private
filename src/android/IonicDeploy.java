    ...
    private void checkForUpdates(CallbackContext callbackContext, String server, final String channel_tag) {
        ...
        try {
            if (response.json != null) {
                ...
                String compatibleRes = compatible?"true":"false";
                String availableRes = updatesAvailable?"true":"false";
                JSONObject updateRes = new JSONObject();
                try
                {
                    updateRes = response.json.getJSONObject("update");
                }
                catch(JSONException e)
                {
                    
                }
                jsonResult.put("compatible",compatibleRes);
                jsonResult.put("available",availableRes);
                jsonResult.put("update",updateRes);
